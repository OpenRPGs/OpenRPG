...
/// </summary>
class SoundManager : public IDisposable {
  public:
	/// <summary>
	/// 싱글톤 인스턴스를 가져옵니다.
	...
	/// <summary>BGM과 모든 SE를 해제합니다.</summary>
	SoundManager* Clear();

	/// <summary>SE 음원의 음량을 설정합니다. 범위는 0.f ~ 100.f 입니다.</summary>
	SoundManager* setVolumeSE(float volume);

	/// <summary>SE 음원의 음량을 가져옵니다. 범위는 0.f ~ 100.f 입니다.</summary>
	float getVolumeSE();

	/// <summary>BGM 음원의 음량을 설정합니다. 범위는 0.f ~ 100.f 입니다.</summary>
	SoundManager* setVolumeBGM(float volume);

	/// <summary>BGM 음원의 음량을 가져옵니다. 범위는 0.f ~ 100.f 입니다.</summary>
	float getVolumeBGM();
