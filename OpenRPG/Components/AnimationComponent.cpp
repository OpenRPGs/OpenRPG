...
AnimationComponent::AnimationComponent(
	g::safe<sf::Sprite> sprite, g::safe<sf::Texture> texture_sheet)
...
void AnimationComponent::addAnimation(
	...
	this->animations[key] = g::safe<Animation>(new Animation(
		this->sprite, this->textureSheet, animation_Timer, start_frame_x, start_frame_y, frames_x,
